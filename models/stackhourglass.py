...
class hourglass(nn.Module):
    def __init__(self, inplanes):
        ...
        self.conv2 = submodule.convbn_3d(inplanes*2, inplanes*2,
...
class PSMNet(nn.Module):
    ...
    def forward(self, left, right):
        ...
        cost = Variable(torch.FloatTensor(refimg_fea.size()[0], refimg_fea.size()[
                        1]*2, math.floor(self.maxdisp/4),  refimg_fea.size()[2],  refimg_fea.size()[3]).zero_())  # .cuda()

        for i in range(math.floor(self.maxdisp/4)):
            if i > 0:
