...
def dataloader(filepath):
    ...
    for im in os.listdir(filepath+'top/'):
        all_left_img.append(filepath+'top/'+im)
        all_right_img.append(filepath+'bottom/'+im)
        all_left_disp.append(filepath+'disparity/'+im.replace('.jpg', '.pfm'))
        # test_left_img.append(filepath+'top/'+im)
        # test_right_img.append(filepath+'bottom/'+im)
        # test_left_disp.append(filepath+'disparity/'+im)
